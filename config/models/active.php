...
return [
    'activeList' => [
        'field' => [
            ...
            'type' => ['text'=>'类型'],
            'time' => ['text'=>'活动时间'],
            'show_start_date' => ['text'=>'显示开始时间'],
            'show_end_date' => ['text'=>'显示结束时间'],
            'address' => ['text'=>'活动地点'],
            'sort' => ['text'=>'排序'],
    ...
    'add' => [
        'field' => [
            ...
            'show_start_date' => ['text'=>'显示开始时间','type'=>'date','value'=>'','verify'=>['required']],
            'show_end_date' => ['text'=>'显示结束时间','type'=>'date','value'=>'','verify'=>['required']],
    ...
    'see' => [
        'field' => [
            ...
            'show_start_date' => ['text'=>'显示开始时间','type'=>'span'],
            'show_end_date' => ['text'=>'显示结束时间','type'=>'span'],
