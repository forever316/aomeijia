...
return [
    'customerConsultList' => [
        'field' => [
            'id' => ['text'=>'ID'],
            'type' => ['text'=>'客户咨询类型','options'=>['1'=>'预约看房','2'=>'预约移民',4=>'预约展会',5=>'客户咨询问答',6=>'客户咨询成功案例',7=>'客户咨询主题',8=>'右侧悬浮框留言',9=>'预约活动']],
            'name' => ['text'=>'客户名字'],
            'phone' => ['text'=>'电话号码'],
            'email' => ['text'=>'邮箱'],
            'wechat' => ['text'=>'微信号'],
        ...
        'search' => [
            ...
            'type' => ['text'=>'客户咨询类型','type'=>'select','value'=>[''=>'--请选择--','1'=>'预约看房','2'=>'预约移民',4=>'预约展会',5=>'客户咨询问答',6=>'客户咨询成功案例',7=>'客户咨询主题',8=>'右侧悬浮框留言',9=>'预约活动']],
        ],
        'button' => [
    ...
    'seeCustomerConsult' => [
        'field' => [
            ...
            'type' => ['text'=>'客户咨询类型','type'=>'select','value'=>['1'=>'预约看房','2'=>'预约移民',4=>'预约展会',5=>'客户咨询问答',6=>'客户咨询成功案例',7=>'客户咨询主题',8=>'右侧悬浮框留言',9=>'预约活动']],
