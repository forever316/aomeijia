...
Source Database       : getrich

Target Server Type    : MYSQL
Target Server Version : 50725
File Encoding         : 65001

Date: 2019-04-15 11:52:04
*/
...
INSERT INTO `admin_user` VALUES ('60', 'admin', '$2y$10$/yP3Y94WrtzAIdha060fj.YIjfT/hcZ1BV5K/0dUs9aS7PDec4KPi', '3756@qq.com', 'pqTRQdZYruGKPIwvOgwkewuUEdDOt57UzlLj3qarHrtsoRGTfpGJZ1IKiQDc', '14', '1C694C95');
...
CREATE TABLE `company_config` (
  ...
  `custom_service_phone` varchar(20) DEFAULT NULL COMMENT '客服电话',
  `img` varchar(255) DEFAULT NULL COMMENT '公司logo',
  `app_version` int(10) DEFAULT '1' COMMENT '安卓app版本号',
  `download_url` varchar(255) NOT NULL DEFAULT '' COMMENT '下载地址',
  `version_des` varchar(255) NOT NULL DEFAULT '' COMMENT '版本描述',
  `po_base_customer` int(13) NOT NULL DEFAULT '0' COMMENT '宝袋基数（消费者）',
  `po_base_store` int(13) NOT NULL,
  `bonus_customer` int(4) NOT NULL DEFAULT '0' COMMENT '消费者消费获得宝分比例',
  `plate_revenue` int(13) NOT NULL DEFAULT '0' COMMENT '平台收益比例',
  `po_base_cash` int(13) NOT NULL DEFAULT '0' COMMENT '宝分兑现比例',
  `po_base_min` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '最低兑现金额',
  `po_base_max` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '最高兑现金额',
  `sign_text` text COMMENT '签到文本',
  `po_base_transfei_customer` int(13) NOT NULL DEFAULT '0' COMMENT '消费者宝分到账可兑现比例',
  `po_base_untransfei_customer` int(13) NOT NULL DEFAULT '0' COMMENT '消费者宝分到账不可兑现比例',
  `spread_first_po_base` int(13) NOT NULL DEFAULT '0' COMMENT '推广1级宝分获得比例，宝分到账',
  `spread_second_po_base` int(13) NOT NULL DEFAULT '0' COMMENT '推广2级宝分获得比例',
  `distributor_po_base_per` int(13) NOT NULL DEFAULT '0' COMMENT '渠道商抽取商家营业额获得宝分比例',
  `agency_po_base_per` int(13) NOT NULL DEFAULT '0' COMMENT '代理商抽取营业额比例',
  `store_apply_amount` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '商家入职申请费用',
  `qudaoshang_apply` decimal(16,2) DEFAULT '0.00' COMMENT '渠道商申请费用',
  `store_amount` int(11) NOT NULL DEFAULT '0' COMMENT '商家消费总额',
  `store_num` int(11) NOT NULL DEFAULT '0' COMMENT '商家数量',
...
-- ----------------------------
INSERT INTO `company_config` VALUES ('1', '致富有限公司', '    致富有限公司        ', '0592-5772309', 'uploads/img/TUepFczEOu.jpg', '0', '0', '0', '200', '40', '0', '0', '0', '0.00', '0.00', '0', '0', '0', '0', '0', '0', '0', '0.00', '0.00', '0', '0', '0', '1C694C95', '2019-04-15 11:51:27', '2017-02-25 14:25:30');
...
CREATE TABLE `menu` (
  ...
  `sort` int(11) DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='权限菜单表';
...
INSERT INTO `menu` VALUES ('3', '2', 'goodsTypeManage', '商品类型管理', '/goodsType/goodsTypeList', '2');
INSERT INTO `menu` VALUES ('4', '2', 'goodsManage', '商品管理', '/goods/goodsList', '1');
INSERT INTO `menu` VALUES ('5', '3', 'wechatConfigManage', '微信配置', '/wechatConfig/wechatConfigList', '1');
...
INSERT INTO `menu` VALUES ('9', '6', 'cadminManage', '公司员工管理', '/user/cuserList', '1');
INSERT INTO `menu` VALUES ('10', '6', 'companyManage', '下属公司管理', '/department/companyList', '2');
INSERT INTO `menu` VALUES ('11', '5', 'financeManage', '资金明细', '/finance/financeList', '1');
INSERT INTO `menu` VALUES ('12', '5', 'withdrawalsMange', '余额提现管理', '/finance/withdrawalsList', '3');
...
INSERT INTO `menu` VALUES ('27', '2', 'goodsNormsManage', '商品规格管理', '/goodsNorms/goodsNormsList', '3');
...
INSERT INTO `menu` VALUES ('33', '4', 'companyConfigManage', '公司资料设置', '/shoppingHome/companyConfigSet', '4');
INSERT INTO `menu` VALUES ('34', '10', 'returnManage', '退货管理', '/order/returnList', '2');
INSERT INTO `menu` VALUES ('35', '5', 'withdrawalsSet', '最低提现金额', '/finance/withdrawalsSet', '5');
...
CREATE TABLE `menu_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_id` (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=410 DEFAULT CHARSET=utf8 COMMENT='菜单角色关联表';
...
CREATE TABLE `resources` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=177 DEFAULT CHARSET=utf8 COMMENT='权限资源表';
...
INSERT INTO `resources` VALUES ('11', '2', '/goodsType/goodsTypeList', '商品类型列表');
INSERT INTO `resources` VALUES ('12', '2', '/goodsType/goodsTypeAdd', '增加商品类型');
INSERT INTO `resources` VALUES ('13', '2', '/goodsType/goodsTypeUpdate', '修改商品类型');
INSERT INTO `resources` VALUES ('14', '2', '/goodsType/goodsTypeDelete', '删除商品类型');
INSERT INTO `resources` VALUES ('15', '2', '/goodsType/ajaxGoodsTypeList', '获取商品类型列表（必选权限）');
INSERT INTO `resources` VALUES ('16', '2', '/goods/goodsList', '商品列表');
INSERT INTO `resources` VALUES ('17', '2', '/goods/goodsAdd', '增加商品');
INSERT INTO `resources` VALUES ('18', '2', '/goods/goodsUpdate', '修改商品');
INSERT INTO `resources` VALUES ('19', '2', '/goods/goodsDetail', '查看商品');
INSERT INTO `resources` VALUES ('20', '2', '/goods/goodsDelete', '删除商品');
INSERT INTO `resources` VALUES ('21', '3', '/wechatConfig/wechatConfigList', '配置列表');
INSERT INTO `resources` VALUES ('22', '3', '/wechatConfig/updateWechatConfig', '编辑配置');
INSERT INTO `resources` VALUES ('23', '3', '/wechatConfig/seeWechatConfig', '查看配置');
INSERT INTO `resources` VALUES ('24', '3', '/wechatConfig/seeToken', '获取接口key（必选）');
INSERT INTO `resources` VALUES ('25', '3', '/wechatMenu/wechatMenuList', '菜单列表');
INSERT INTO `resources` VALUES ('26', '3', '/wechatMenu/addWechatMenu', '添加菜单');
INSERT INTO `resources` VALUES ('27', '3', '/wechatMenu/updateWechatMenu', '更新菜单');
INSERT INTO `resources` VALUES ('28', '3', 'wechatMenu/seeWechatMenu', '查看菜单');
INSERT INTO `resources` VALUES ('29', '3', '/wechatMenu/deleteWechatMenu', '删除菜单');
INSERT INTO `resources` VALUES ('30', '3', '/wechatMenu/publish', '发布菜单');
...
INSERT INTO `resources` VALUES ('48', '2', '/goodsType/ajaxGoodsTypeAttribute', '根据类型获取属性（必选）');
INSERT INTO `resources` VALUES ('49', '6', '/user/cuserList', '公司员工列表');
INSERT INTO `resources` VALUES ('51', '6', '/department/companyList', '下属公司列表');
INSERT INTO `resources` VALUES ('52', '6', '/department/ajaxFirstList', '获取公司列表');
INSERT INTO `resources` VALUES ('53', '5', '/finance/financeList', '资金明细');
INSERT INTO `resources` VALUES ('54', '5', '/finance/withdrawalsList', '提现记录');
INSERT INTO `resources` VALUES ('55', '5', '/finance/withdrawalsAudit', '提现审核');
INSERT INTO `resources` VALUES ('56', '6', '/user/updateCuser', '企业管理员修改');
INSERT INTO `resources` VALUES ('57', '6', '/user/addCuser', '添加企业管理员');
INSERT INTO `resources` VALUES ('58', '3', '/wechatConfig/addWechatConfig', '添加配置');
...
INSERT INTO `resources` VALUES ('84', '8', '/article/articleTypeList', '文章类型列表');
INSERT INTO `resources` VALUES ('85', '8', '/article/articleList', '文章列表');
INSERT INTO `resources` VALUES ('86', '8', '/article/addArticle', '添加文章');
INSERT INTO `resources` VALUES ('87', '8', '/article/updateArticle', '编辑文章');
INSERT INTO `resources` VALUES ('88', '8', '/article/deleteArticle', '删除文章');
INSERT INTO `resources` VALUES ('89', '8', '/article/seeArticle', '查看文章');
INSERT INTO `resources` VALUES ('90', '8', '/article/addArticleType', '添加文章类型');
INSERT INTO `resources` VALUES ('91', '8', '/article/updateArticleType', '编辑文章类型');
INSERT INTO `resources` VALUES ('92', '8', '/article/deleteArticleType', '删除文章类型');
...
INSERT INTO `resources` VALUES ('105', '5', '/finance/integralList', '宝分明细列表');
...
INSERT INTO `resources` VALUES ('108', '5', '/finance/recharge', '充值');
...
INSERT INTO `resources` VALUES ('116', '2', '/goodsNorms/goodsNormsList', '商品规格列表');
INSERT INTO `resources` VALUES ('117', '2', '/goodsNorms/goodsNormsAdd', '增加商品规格');
INSERT INTO `resources` VALUES ('118', '2', '/goodsNorms/goodsNormsUpdate', '修改商品规格');
INSERT INTO `resources` VALUES ('119', '2', '/goodsNorms/goodsNormsDelete', '删除商品规格');
INSERT INTO `resources` VALUES ('120', '2', '/goodsNorms/normsAttrList', '规格属性列表');
INSERT INTO `resources` VALUES ('121', '2', '/goodsNorms/normsAttrAdd', '增加规格属性');
INSERT INTO `resources` VALUES ('122', '2', '/goodsNorms/normsUpdate', '修改规格属性');
INSERT INTO `resources` VALUES ('123', '2', '/goodsNorms/normsAttrDelete', '删除规格属性');
INSERT INTO `resources` VALUES ('124', '2', '/goodsNorms/ajaxGoodsNormsList', '获取商品规格数据（必选）');
INSERT INTO `resources` VALUES ('125', '2', '/goodsNorms/ajaxNormsAttrList', '根据规格获取属性（必选）');
INSERT INTO `resources` VALUES ('126', '2', '/goodsNorms/ajaxGoodsAttrList', '获取商品原有规格（必选）');
...
INSERT INTO `resources` VALUES ('140', '5', '/finance/integralWithdrawalsList', '宝分兑换记录列表');
INSERT INTO `resources` VALUES ('141', '5', '/finance/integralWithdrawalsAudit', '宝分兑换审核');
INSERT INTO `resources` VALUES ('142', '10', '/order/deliverGoodsSet', '设置为已发货');
INSERT INTO `resources` VALUES ('143', '4', '/shoppingHome/companyConfigSet', '公司资料设置');
INSERT INTO `resources` VALUES ('144', '10', '/order/returnList', '退货列表');
INSERT INTO `resources` VALUES ('146', '5', '/finance/withdrawalsSet', '设置最低提现金额');
INSERT INTO `resources` VALUES ('153', '5', '/finance/stockBus', '股东业务');
INSERT INTO `resources` VALUES ('154', '5', '/finance/rankingList', '排行榜');
...
) ENGINE=InnoDB AUTO_INCREMENT=1708 DEFAULT CHARSET=utf8 COMMENT='角色资源表';
...
INSERT INTO `resources_role` VALUES ('528', '13', '/member/distributorList', '1C694C95');
INSERT INTO `resources_role` VALUES ('532', '13', '/member/distributorDelete', '1C694C95');
...
INSERT INTO `resources_role` VALUES ('629', '13', '/shoppingHome/modularList', '1C694C95');
INSERT INTO `resources_role` VALUES ('630', '13', '/shoppingHome/modularAdd', '1C694C95');
INSERT INTO `resources_role` VALUES ('631', '13', '/shoppingHome/modularUpdate', '1C694C95');
INSERT INTO `resources_role` VALUES ('632', '13', '/shoppingHome/modularDelete', '1C694C95');
INSERT INTO `resources_role` VALUES ('645', '13', '/shoppingHome/companyConfigSet', '1C694C95');
INSERT INTO `resources_role` VALUES ('647', '13', '/order/updateReturn', '1C694C95');
INSERT INTO `resources_role` VALUES ('649', '13', '/user/stockholderList', '1C694C95');
INSERT INTO `resources_role` VALUES ('650', '13', '/user/addStockholder', '1C694C95');
INSERT INTO `resources_role` VALUES ('651', '13', '/user/updateStockholder', '1C694C95');
INSERT INTO `resources_role` VALUES ('652', '13', '/user/deleteStockholder', '1C694C95');
INSERT INTO `resources_role` VALUES ('653', '13', '/user/seeStockholder', '1C694C95');
...
INSERT INTO `resources_role` VALUES ('1681', '13', '/member/distributorList', '1C694C95');
INSERT INTO `resources_role` VALUES ('1682', '13', '/member/updateDistributor', '1C694C95');
INSERT INTO `resources_role` VALUES ('1683', '13', '/member/distributorDelete', '1C694C95');
