<div class="form-group">
    ...
    <div class="col-sm-10" style="width: 70%" id="modular_type">
        ...
        <label class="checkbox-inline i-checks">
            <input  type="radio" name="modular_type" id="modular_type4" value="4" @if(isset($detailData->modular_type)&&$detailData->modular_type == '4') checked @endif> <i></i>类型4</label>
        <label class="checkbox-inline i-checks">
            <input   type="radio" name="modular_type" id="modular_type2" value="2" @if(isset($detailData->modular_type)&&$detailData->modular_type == '2') checked @endif> <i></i>类型2</label>
    </div>
    <script>
        $(function(){
...
<div class="form-group" id="2img" @if(isset($detailData->modular_type)&&$detailData->modular_type == '4') style="display: none" @endif >
    <label class="col-sm-1 control-label">模块参考图</label>
    <div class="col-sm-10" style="width: 70%">
        <img src="/assets/admin/img/4.png" width="20%" height="20%" />
    </div>
</div>
<div class="form-group" id="5img" @if(isset($detailData->modular_type)&&$detailData->modular_type == '2') style="display: none" @endif>
    <label class="col-sm-1 control-label">模块参考图</label>
    <div class="col-sm-10" style="width: 70%">
...
<div id="modular_type_content">
    @if(isset($detailData->modular_type)&&$detailData->modular_type == '2')
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label">模块内容2</label>
            <div class="col-sm-10" style="width: 70%">
                                ...
                                <div style="overflow:hidden;">
                                    ...
                                    <div style="overflow: hidden;">
                                        ...
                                        <div style="overflow:hidden;" id="value">
                                            ...
                                            @if(isset($homeModularContentList['goodsList'])&&$homeModularContentList['goodsList'])
                                                @foreach($homeModularContentList['goodsList'] as $k => $v)
                                                <div class="list"><input type="hidden" class="form-control" name="goods_id[]" value="{{$v['id']}}"> <input type="text" style="width: 30%;display: inline;" class="form-control" name="goods_name" value="{{$v['name']}}"><button class="btn btn-primary del" type="button">删除</button></div>
                                                @endforeach
                                                    @endif
                                        </div>
                                    </div>
        ...
        @endif
        @if(isset($detailData->modular_type)&&$detailData->modular_type == '4')
            <link rel="stylesheet" href="/assets/common/bootstrap-table/bootstrap-table.css">
            <script src="/assets/common/bootstrap-table/bootstrap-table.js"></script>
            <script src="/assets/common/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
            <style>
