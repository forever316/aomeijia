                    ...
                    <div id="ibox-content" class="table-responsive">
                        ...
                        @if(isset($form['search']))
                            <div class="search form-horizontal" style="overflow:hidden;">
                                <form id="searchForm" method="post" action="/finance/stockBus" class="form-horizontal">
                        ...
                        <div style="background-color: #F5F5F6;padding: 8px;border: 1px solid #dddddd;border-bottom: 0;">
                            <button style="margin: 0px;" class="btn btn-primary" type="button">历史总额度：{!!$stockBusAmount!!}</button>
                            <button style="margin: 0px;" class="btn btn-primary" type="button">历史积分使用总额：{!!$stockBusUse!!}</button>
                            <button style="margin: 0px;" class="btn btn-primary" type="button">历史积分未使用总额：{!!$stockBusNotUse!!}</button>
                            <button style="margin: 0px;" class="btn btn-primary" type="button">今日总额度：{!!$stockTodayAmoubt!!}</button>
                        ...
                        <table id="dataTable" style="border-bottom: 0px;">
                            ...
                            <tr>
                                @foreach ($form['field'] as $key=>$item)
                                    <th data-align="center" key="{{$key}}" data-field="{{$key}}">{{$item['text']}}</th>
                                @endforeach
                            </tr>
                            </thead>
                        </table>
