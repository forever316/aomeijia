        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" style="padding-top: 20px;">
                    <form id="editForm" method="post" action="/finance/withdrawalsSet" class="form-horizontal">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                        <div class="form-group">
                            <label class="col-sm-1 control-label" for="withdrawals_amount">最低金额</label>
                            <div class="col-sm-11" style="width: 50%">
                                <input name="withdrawals_amount" type="text"  class="form-control" value="{!!$amount['withdrawals_amount']!!}" id="withdrawals_amount"/>
                            </div>
                        </div>
