    ...
    methods: {
      ...
      handleScroll () {
        ...
        window.onscroll = function () {
          ...
          var t = document.querySelector('.header-wrapper').offsetHeight + self.$refs.banner.offsetHeight + self.$refs.basic.offsetHeight;
          self.isNavFixed = scrollTop > t && scrollTop < t + self.$refs.content.offsetHeight - self.$refs.house.offsetHeight;
